      ...
      <tr>
        ...
        <td class="align-middle">
          <a href="<?php echo BASEURL; ?>view.php?id=3"
            class="btn btn-success">View</a>
          <a href="<?php echo BASEURL; ?>add-contact.php?id=3"
            class="btn btn-primary">Edit</a>
      ...
      <tr>
        ...
        <td class="align-middle">
          <a href="<?php echo BASEURL; ?>view.php?id=1"
            class="btn btn-success">View</a>
          <a href="<?php echo BASEURL; ?>add-contact.php?id=1"
            class="btn btn-primary">Edit</a>
      ...
      <tr>
        ...
        <td class="align-middle">
          <a href="<?php echo BASEURL; ?>view.php?id=8"
            class="btn btn-success">View</a>
          <a href="<?php echo BASEURL; ?>add-contact.php?id=8"
            class="btn btn-primary">Edit</a>
      ...
      <tr>
        ...
        <td class="align-middle">
          <a href="<?php echo BASEURL; ?>view.php?id=2"
            class="btn btn-success">View</a>
          <a href="<?php echo BASEURL; ?>add-contact.php?id=2"
            class="btn btn-primary">Edit</a>
