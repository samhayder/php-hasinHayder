    ...
    <div class="row blog-entries">
        ...
        <div class="row mb-5 mt-5">
          ...
          <div class="col-md-12">
            ...
            <div class="post-entry-horzontal">
              <a href="<?php echo URL; ?>blog-single.php">
            ...
            <nav aria-label="Page navigation" class="text-center">
              <ul class="pagination">
                <li class="page-item  active"><a class="page-link"
                    href="<?php echo URL; ?>#">&lt;</a></li>
                <li class="page-item"><a class="page-link"
                    href="<?php echo URL; ?>#">1</a></li>
                <li class="page-item"><a class="page-link"
                    href="<?php echo URL; ?>#">2</a></li>
                <li class="page-item"><a class="page-link"
                    href="<?php echo URL; ?>#">3</a></li>
                <li class="page-item"><a class="page-link"
                    href="<?php echo URL; ?>#">4</a></li>
                <li class="page-item"><a class="page-link"
                    href="<?php echo URL; ?>#">5</a></li>
                <li class="page-item"><a class="page-link"
                    href="<?php echo URL; ?>#">&gt;</a></li>
              </ul>
            </nav>
      ...
      <div class="col-md-12 col-lg-4 sidebar">
          ...
          <div class="bio text-center">
            ...
            <div class="bio-body">
              ...
              <p><a href="<?php echo URL; ?>#"
                  class="btn btn-primary btn-sm rounded">Read my bio</a></p>
              <p class="social">
                <a href="<?php echo URL; ?>#" class="p-2"><span
        ...
        <div class="sidebar-box">
          ...
          <ul class="categories">
            <li><a href="<?php echo URL; ?>#">Food <span>(12)</span></a></li>
            <li><a href="<?php echo URL; ?>#">Travel <span>(22)</span></a></li>
            <li><a href="<?php echo URL; ?>#">Lifestyle <span>(37)</span></a>
            </li>
            <li><a href="<?php echo URL; ?>#">Business <span>(42)</span></a></li>
            <li><a href="<?php echo URL; ?>#">Adventure <span>(14)</span></a>
            </li>
          </ul>
        </div>
        <!-- END sidebar-box -->
        ...
        <div class="sidebar-box">
          ...
          <ul class="tags">
            <li><a href="<?php echo URL; ?>#">Travel</a></li>
            <li><a href="<?php echo URL; ?>#">Adventure</a></li>
            <li><a href="<?php echo URL; ?>#">Food</a></li>
            <li><a href="<?php echo URL; ?>#">Lifestyle</a></li>
            <li><a href="<?php echo URL; ?>#">Business</a></li>
            <li><a href="<?php echo URL; ?>#">Freelancing</a></li>
            <li><a href="<?php echo URL; ?>#">Travel</a></li>
            <li><a href="<?php echo URL; ?>#">Adventure</a></li>
            <li><a href="<?php echo URL; ?>#">Food</a></li>
            <li><a href="<?php echo URL; ?>#">Lifestyle</a></li>
