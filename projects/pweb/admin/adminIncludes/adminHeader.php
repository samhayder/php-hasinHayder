        ...
        <div class="d-flex">
          ...
          <div class="dropdown d-inline-block language-switch">
            <button type="button" class="btn header-item waves-effect"
              ...
              aria-expanded="false">
              <img src="assets/images/flags/us.jpg" alt="Header Language"
                height="16">
            </button>
          ...
          <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect"
              ...
              <span
                class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">Marcus</span>
              <i
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <a class="dropdown-item" href="#"><i
                  class="uil uil-wallet font-size-18 align-middle me-1 text-muted"></i>
              ...
              <a class="dropdown-item" href="#"><i
                  class="uil uil-lock-alt font-size-18 align-middle me-1 text-muted"></i>
