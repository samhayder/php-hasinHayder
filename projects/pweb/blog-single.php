      ...
      <div class="col-md-12 col-lg-8 main-content">
        ...
        <div class="post-meta">
          <span class="author mr-2"><img src="images/person_1.jpg"
              alt="Colorlib" class="mr-2"> Colorlib</span>&bullet;
          <span class="mr-2">March 15, 2018 </span> &bullet;
          <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
        </div>
        <h1 class="mb-4">There’s a Cool New Way for Men to Wear Socks and
          Sandals</h1>
        <a class="category mb-5" href="#">Food</a> <a class="category mb-5"
          href="#">Travel</a>
        ...
        <div class="post-content-body">
          ...
          <p>Sint ab voluptates itaque, ipsum porro qui obcaecati cumque quas
          ...
          <p>Quis eius aspernatur, eaque culpa cumque reiciendis, nobis at earum
            ...
            itaque voluptatem. Commodi, sequi.</p>
          <div class="row mb-5">
          ...
          <p>Quibusdam autem, quas molestias recusandae aperiam molestiae modi
          ...
          <p>Temporibus quo dolore veritatis doloribus delectus dolores
            ...
            minima.</p>
          <p>Porro amet accusantium libero fugit totam, deserunt ipsa, dolorem,
          ...
          <p>Illo magnam at dolore ad enim fugiat ut maxime facilis autem, nulla
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            ...
            provident obcaecati sapiente, animi vel expedita omnis quae ipsa!
            Obcaecati eligendi sed odio labore vero reiciendis facere accusamus
            molestias eaque impedit, consequuntur quae fuga vitae fugit?</p>
        </div>
        ...
        <div class="sidebar-box">
          <div class="bio text-center">
            ...
            <div class="bio-body">
              ...
              <p><a href="#" class="btn btn-primary btn-sm rounded">Read my
                  bio</a></p>
              <p class="social">
              ...
              <li>
                <a href="">
                  <img src="images/img_1.jpg" alt="Image placeholder"
                    class="mr-4">
                  <div class="text">
                    <h4>There’s a Cool New Way for Men to Wear Socks and Sandals
                    </h4>
                    <div class="post-meta">
